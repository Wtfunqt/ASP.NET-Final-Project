...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SanjayDBConnectionString %>" SelectCommand="select am.title, am.prodyear, s.summary from SanjayDB.dbo.summaries s join SanjayDB.dbo.allmovies am on s.id=am.id"></asp:SqlDataSource>
